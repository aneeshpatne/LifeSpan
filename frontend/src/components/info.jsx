...
const sampleData = [
  {
    ...
    data: "Ensures early disease detection, proper medical care, and vaccinations, reducing mortality rates and improving overall health outcomes.",
    icon: <Stethoscope />,
  },
  {
    heading: "Environmental Conditions",
    data: "Poor air and water quality contribute to respiratory diseases, cardiovascular issues, and lower life expectancy. Clean environments promote healthier living.",
    icon: <Leaf />,
  },
  {
    heading: "Socioeconomic Status",
    data: "Higher income and education levels improve healthcare access, reduce stress, and lead to healthier lifestyle choices, increasing life expectancy.",
    icon: <Banknote />,
  },
  {
    heading: "Lifestyle Factors",
    data: "Diet, exercise, smoking, and alcohol consumption directly affect longevity. Healthy habits significantly reduce the risk of chronic diseases.",
    icon: <Dumbbell />,
  },
];
    ...
    <div className="relative min-h-[92vh] bg-teal-900 px-4 py-6 text-white">
      ...
      <div className="mx-auto flex max-w-xl">
        <Input
          ...
          className=" rounded-r-none border-0 py-1.5 pl-4 text-black ring-1 ring-inset ring-gray-300
                ...
                <CardContent>
                  <div className="mx-auto w-full max-w-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div
                        className={`text-xl font-bold ${pm25Status.textColor}`}
                      >
                        {pm25Value} μg/m³
                      </div>
                    </div>
                    ...
                    <div className="mt-4 rounded-lg bg-gray-50 p-2 text-sm text-gray-600">
                      <div className="flex items-start gap-2">
                        ...
                        <p>
                          ...
                          micrometers or smaller in diameter. These particles
                          can penetrate deep into the lungs and bloodstream,
                          causing significant health impacts. WHO guidelines
                          recommend levels below 5 μg/m³ for annual mean.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-8 max-w-4xl mx-auto">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  AI-powered analysis of your local air quality and health
                  impact
                </CardDescription>
              </CardHeader>
              <CardContent>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 space-y-2 text-gray-600">
                      ...
                      <div className="pt-2 text-sm text-gray-500">
                        <em>
                          AI Generated Text using the Pollution levels, change
                          in life expectancy and dedicated knowledge base.
                        </em>
                      </div>
                    </div>
                  </div>
        ...
        <>
          <div className="flex flex-col gap-5 px-10 mt-5">
            <h1 className="mt-8 text-4xl font-semibold text-center">
              Enter your location to calculate the impact!
            </h1>
            <div className="grid grid-cols-2 gap-5 w-full mx-auto mt-15 p-5">
...
function Badge({ name, data, icon }) {
  return (
    <div className="flex gap-2 ">
      <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-emerald-500 flex-shrink-0">
        {icon}
      </div>
